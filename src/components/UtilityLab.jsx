  ...
  return (
    ...
    >
      {data.map((val, i) => (
        <div
          key={`pbi-${metric}-${i}`}
          className="flex-1 flex flex-col justify-end items-center gap-3 md:gap-4 group h-full"
        >
          <motion.div
            initial={{ height: 0 }}
            animate={{ height: `${val}%` }}
            ...
            style={{ minHeight: "4px" }}
          />
          <span className="font-mono text-[8px] text-stone-700 uppercase">
            M.0{i + 1}
          </span>
        </div>
      ))}
      ...
      {events.map((ev, i) => (
        ...
        >
          ...
          <div className="flex items-center gap-3 sm:gap-4 md:gap-6 text-right shrink-0">
            ...
            <span className="font-mono text-[9px] text-stone-500 w-8 md:w-10">
              {ev.rate}
            </span>
          </div>
        </motion.div>
        ...
        <div className="space-y-2 flex-1">
          {tags.map((tag, i) => (
            ...
            >
              ...
              <span className="font-mono text-[9px] text-stone-300 truncate">
                {tag.name}
              </span>
            </motion.div>
          ))}
